...
import com.vondear.rxtools.model.scaner.OnRxScanerListener;
import com.vondear.rxtools.model.scaner.PlanarYUVLuminanceSource;
import com.vondear.rxtools.model.scaner.decoding.InactivityTimer;
import com.vondear.rxtools.model.tool.RxQrBarTool;
import com.vondear.rxtools.utils.RxAnimationUtils;
import com.vondear.rxtools.utils.RxBeepTool;
...
public class ActivityScanerCode extends AppCompatActivity {
    ...
    private void initPermission() {
        ...
        if (ContextCompat.checkSelfPermission(mContext, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED &&
            ...
            ActivityCompat.requestPermissions((Activity) mContext, new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        }
    }
    ...
    public void btn(View view) {
        ...
        if (viewId == R.id.top_mask) {
            ...
            startActivity(RxCameraUtils.getImagePickerIntent());
        }
    }
    ...
    public void handleDecode(Result result) {
        ...
        //扫描成功之后的振动与声音提示
        RxBeepTool.playBeep((Activity) mContext, vibrate);
