 ...
 * </pre>
 */
public final class RxSpanUtils {
     ...
     *             </ul>
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setForegroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setBackgroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setBullet(@ColorInt final int color,
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setFontProportion(final float proportion) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setFontXProportion(final float proportion) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setStrikethrough() {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setUnderline() {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setSuperscript() {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setSubscript() {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                               final Blur style) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                 final float dx,
                                 final float dy,
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils appendImage(@NonNull final Uri uri) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils appendImage(@DrawableRes final int resourceId) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils appendImage(@DrawableRes final int resourceId, @Align final int align) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link RxSpanUtils} instance
     */
    public RxSpanUtils appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
...
//            }
    ...
    class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(RxUtils.getContext().getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            RxUtils.getContext().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(RxUtils.getContext().getResources(), bitmap);
                    drawable.setBounds(
                ...
                try {
                    drawable = ContextCompat.getDrawable(RxUtils.getContext(), mResourceId);
                    drawable.setBounds(
                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
                    );
                } catch (Exception e) {
