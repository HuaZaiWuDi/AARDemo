...
public final class RxScreenUtils {
    ...
    public static boolean isLandscape() {
        return RxUtils.getContext().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) RxUtils.getContext().getSystemService(Context.KEYGUARD_SERVICE);
        //noinspection ConstantConditions
    ...
    public static void setSleepDuration(final int duration) {
        Settings.System.putInt(
                RxUtils.getContext().getContentResolver(),
    ...
    public static boolean isTablet() {
        return (RxUtils.getContext().getResources().getConfiguration().screenLayout
