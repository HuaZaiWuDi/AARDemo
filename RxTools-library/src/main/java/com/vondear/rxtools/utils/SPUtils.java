...
public final class SPUtils {
     ...
     * @return the single {@link SPUtils} instance
     */
    public static SPUtils getInstance(Application app) {
     ...
     * @return the single {@link SPUtils} instance
     */
    public static SPUtils getInstance(Application app, String spName) {
        if (isSpace(spName)) spName = "spUtils";
        SPUtils spUtils = SP_UTILS_MAP.get(spName);
        if (spUtils == null) {
            spUtils = new SPUtils(app, spName);
            SP_UTILS_MAP.put(spName, spUtils);
        }
        return spUtils;
    }

    private SPUtils(Application app, final String spName) {
        sp = app.getSharedPreferences(spName, Context.MODE_PRIVATE);
    }
