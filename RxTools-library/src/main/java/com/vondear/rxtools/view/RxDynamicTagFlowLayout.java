 ...
 */
public class RxDynamicTagFlowLayout extends ViewGroup {

    private List<String> mTags = new ArrayList<String>();
    private Adapter mAdapter;

    public RxDynamicTagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public RxDynamicTagFlowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RxDynamicTagFlowLayout(Context context) {
        super(context);
    }
