 ...
 */
public class RxMagicLineView extends View {
    private static final String TAG = "RxMagicLineView";
    //起点在x、y移动范围
    ...
    public RxMagicLineView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RxMagicLineView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public RxMagicLineView(Context context) {
        super(context);
        init();
    }
...
//        RadialGradient shader = new RadialGradient(viewWidth / 2, viewHeight / 2, viewWidth / 2, colors, null, Shader.TileMode.CLAMP);
