 ...
 * 创建时间：2017/12/25
 */
public class RxHeartRateLineView extends View {

    private int mWidth;
    private int mHeight;


    public RxHeartRateLineView(Context context) {
        this(context, null);
    }

    public RxHeartRateLineView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RxHeartRateLineView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
