 ...
 * </pre>
 */
public final class RxSnackbarUtils {
    ...
    private RxSnackbarUtils(final View parent) {
        setDefault();
        this.view = parent;
    }
     ...
     * @return the single {@link RxSnackbarUtils} instance
     */
    public static RxSnackbarUtils with(@NonNull final View view) {
        return new RxSnackbarUtils(view);
    }
     ...
     * @return the single {@link RxSnackbarUtils} instance
     */
    public RxSnackbarUtils setMessage(@NonNull final CharSequence msg) {
        this.message = msg;
        return this;
    }
     ...
     * @return the single {@link RxSnackbarUtils} instance
     */
    public RxSnackbarUtils setMessageColor(@ColorInt final int color) {
     ...
     * @return the single {@link RxSnackbarUtils} instance
     */
    public RxSnackbarUtils setBgColor(@ColorInt final int color) {
        this.bgColor = color;
        return this;
    }
     ...
     * @return the single {@link RxSnackbarUtils} instance
     */
    public RxSnackbarUtils setBgResource(@DrawableRes final int bgResource) {
     ...
     * @return the single {@link RxSnackbarUtils} instance
     */
    public RxSnackbarUtils setDuration(@Duration final int duration) {
     ...
     * @return the single {@link RxSnackbarUtils} instance
     */
    public RxSnackbarUtils setAction(@NonNull final CharSequence text,
     ...
     */
    public RxSnackbarUtils setBottomMargin(@IntRange(from = 1) final int bottomMargin) {
