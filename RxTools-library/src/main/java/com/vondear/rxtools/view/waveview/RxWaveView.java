...
public class RxWaveView extends View {
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#2889CFF0");
    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#3C89CFF0");
