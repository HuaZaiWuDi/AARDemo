 ...
 * @author ZhongDaFeng
 */
public class RxImageViewHelper {
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RxImageView);
        //icon
        //Vector兼容处理
        ...
        mCorner = a.getDimensionPixelSize(R.styleable.RxImageView_corner_radius, -1);
        mCornerTopLeft = a.getDimensionPixelSize(R.styleable.RxImageView_corner_radius_top_left, 0);
        mCornerTopRight = a.getDimensionPixelSize(R.styleable.RxImageView_corner_radius_top_right, 0);
        mCornerBottomLeft = a.getDimensionPixelSize(R.styleable.RxImageView_corner_radius_bottom_left, 0);
        mCornerBottomRight = a.getDimensionPixelSize(R.styleable.RxImageView_corner_radius_bottom_right, 0);
        mBorderWidth = a.getDimensionPixelSize(R.styleable.RxImageView_border_width, 0);
        mBorderColor = a.getColor(R.styleable.RxImageView_border_color, Color.BLACK);
    ...
    public RxImageViewHelper setIconNormal(Drawable icon) {
