 ...
 * 描述：下载进度条 添加圆角支持 on 2016/11/11
 * </br>
 */
public class RxLoadProgressBar extends View implements Runnable {
    ...
    public RxLoadProgressBar(Context context) {
        this(context, null, 0);
    }

    public RxLoadProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RxLoadProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
